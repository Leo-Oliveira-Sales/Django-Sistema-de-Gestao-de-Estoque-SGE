...
urlpatterns = [
    ...
    path("api/av1/brands", views.BrandCreateListAPIView.as_view(), name="brand_create_list_api_view"),
    path("api/av1/brands/<int:pk>", views.BrandRetrieveUpdateDestroyAPIView.as_view(), name="brand_detail_api_view"),
]
